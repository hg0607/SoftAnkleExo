...
#define SET_485_RE_UP() HAL_GPIO_WritePin(SP3485_RE_GPIO_Port, SP3485_RE_Pin, GPIO_PIN_SET)
#define SET_485_RE_DOWN() HAL_GPIO_WritePin(SP3485_RE_GPIO_Port, SP3485_RE_Pin, GPIO_PIN_RESET)
